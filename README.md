...
- **MVP 做了什么**：用一个可交互 Demo 模拟 AI 如何根据门店信息生成、编辑、导出和保存套餐诊断报告。
...
Demo 是一个可交互产品原型。店主可以直接填写门店类型、商圈、主推套餐、当前困惑和近 7 天数据，再点击“生成诊断”获得一套可执行方案。顶部 3 个场景仍可一键填充示例：
...
- **核销提升**：设计到店话术、加购品和二次券。
- **下一步决策**：用曝光、咨询、核销、加购等指标判断继续投、改套餐、改内容或暂停。
- **诊断依据和行动清单**：解释为什么这么判断，并列出今天先做的 3 件事。
- **导出和复用**：支持复制 Markdown、下载报告、保存最近 5 份本地历史、重新生成内容样片。
- **经营增强**：包含报告对比、3 天后复盘模板和 3 个小红书笔记角度。
